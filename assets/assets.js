...
import instagram_icon from "./newinstaa.svg";
...
export const productsDummyData = [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhSIhw",
    name: "AULA Gaming Mouse",
    description:
      "The AULA Gaming Mouse combines precision and performance with customizable RGB lighting and an ergonomic design. Featuring 7 programmable buttons, up to 7200 DPI, and ultra-responsive tracking, it’s built for gamers who demand accuracy and speed. Ideal for FPS, MOBA, and all competitive gameplay.",
    price: 39.99,
    offerPrice: 29.99,
    image: [
      "https://www.ryans.com/storage/products/main/aula-f815-wired-black-gaming-11731127687.webp",
    ],
    category: "Mouse",
    date: 1738668619198,
    __v: 0,
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: 'HP M22f 21.5" FHD IPS Monitor',
    description:
      'The HP M22f 21.5" FHD IPS Monitor delivers stunning visuals with vibrant color accuracy and ultra-wide viewing angles. Featuring a sleek micro-edge design, AMD FreeSync technology, and Eye Ease low blue light, it’s perfect for both productivity and entertainment.',
    price: 159.99,
    offerPrice: 139.99,
    image: [
      "https://www.ryans.com/storage/products/main/hp-m22f-215-inch-fhd-ips-monitor-21725098223.webp",
    ],
    category: "Monitor",
    date: 1738668619198,
    __v: 0,
